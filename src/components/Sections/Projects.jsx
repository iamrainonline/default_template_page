...
const Projects = () => {
  ...
  return (
    <div className="relative bg-black min-h-screen w-full overflow-hidden py-24 md:py-32">
      {/* Întreaga componentă este scalată la 70% */}
      <div
        className="transform scale-75
       origin-top absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full "
        style={{ height: "1100px" }}
      >
        {/* Restul componentei */}
        <div
